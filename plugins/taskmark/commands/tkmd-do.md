...
When the target is a story or epic, every open, non-cancelled, non-shelved
descendant leaf is mandatory scope. Do not stop successfully until all required
descendants are done; their parent statuses are derived at read time and parent
markdown stays unchanged. If a definitive blocker prevents one leaf from
completing, leave it open and report the whole target incomplete.
